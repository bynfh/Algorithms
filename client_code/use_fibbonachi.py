from algorithms.calculators_sequense.fibbonachi import fib_recursion_calculate, fib_iteration_calculate

print("=" * 5 + "Start tests first block" + "=" * 5)
assert fib_recursion_calculate(5) == 8
assert fib_iteration_calculate(5) == 8
assert fib_recursion_calculate(6) == 13
